/*
 * ECE473_ADC_InClassExercise.c
 *
 * Created: 11/7/2016 4:10:16 PM
...
void _mainInit(void){
	...
	// Set-up ADMUX: => single-ended input & input PORTF bit 7 (MUX4=0,MUX3=0,MUX2=1,MUX1=1,MUX0=1), right adjusted (ADLAR =0), 10 bits, Using AVCC as refrence(REFS1=0, REFS0=1)
	ADMUX |= (1<<REFS0)|(1<<MUX2)|(1<<MUX1)|(1<<MUX0);  //
	//Set-up ADCSRA: =>	ADC enabled(ADEN =1), don't start yet(ADCS =0), single shot mode(ADFR=0),division factor is 128 (125khz)(ADPS2=1,ADPS1=1,ADPS0=1)
