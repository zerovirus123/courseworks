...
//declare the 2 byte TWI read and write buffers (lm73_functions_skel.c)
...
//      itoa(lm73_temp, lcd_string_array, 10); 
      snprintf(lcd_string_array,16, "%d.%-2d %c",lm73_temp>>7, ((lm73_temp & (0x3<<5))*25)>>5, 'C');
      //itoa(0xe487, lcd_string_array, 10); 
